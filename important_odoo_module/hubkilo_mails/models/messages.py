...
class ResConfigSettings(models.TransientModel):
    ...
    shipping_price_proposed_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_price_proposed_email_template_id_traveler',
    )
    ...
    shipping_price_proposed_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_price_proposed_email_template_id_sender',
    )
    ...
    shipping_price_validated_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_price_validated_email_template_id_traveler',
    )
    ...
    shipping_price_validated_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_price_validated_email_template_id_sender',
    )
    ...
    def get_values(self):
        ...
        enable_shipping_price_proposed_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_price_proposed_email_traveler')
        shipping_price_proposed_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_price_proposed_email_template_id_traveler')
        enable_shipping_price_proposed_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_price_proposed_email_sender')
        shipping_price_proposed_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_price_proposed_email_template_id_sender')

        enable_shipping_price_validated_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_price_validated_email_traveler')
        shipping_price_validated_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_price_validated_email_template_id_traveler')
        enable_shipping_price_validated_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_price_validated_email_sender')
        shipping_price_validated_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_price_validated_email_template_id_sender')
    ...
    def set_values(self):
        ...
        params.set_param('hubkilo_mails.enable_shipping_price_proposed_email_traveler',
                         self.enable_shipping_price_proposed_email_traveler)
        params.set_param('hubkilo_mails.shipping_price_proposed_email_template_id_traveler',
                         self.shipping_price_proposed_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_price_proposed_email_sender',
                         self.enable_shipping_price_proposed_email_sender)
        params.set_param('hubkilo_mails.shipping_price_proposed_email_template_id_sender',
                         self.shipping_price_proposed_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_price_validated_email_traveler',
                         self.enable_shipping_price_validated_email_traveler)
        params.set_param('hubkilo_mails.shipping_price_validated_email_template_id_traveler',
                         self.shipping_price_validated_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_price_validated_email_sender',
                         self.enable_shipping_price_validated_email_sender)
        params.set_param('hubkilo_mails.shipping_price_validated_email_template_id_sender',
