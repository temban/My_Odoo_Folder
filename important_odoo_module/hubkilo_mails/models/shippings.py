...
class ResConfigSettings(models.TransientModel):
    ...
    shipping_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_email_template_id_traveler',
    )
    ...
    shipping_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_email_template_id_sender',
    )
    ...
    shipping_rejected_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_rejected_email_template_id_traveler',
    )
    ...
    shipping_rejected_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_rejected_email_template_id_sender',
    )
    ...
    shipping_cancelled_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_cancelled_email_template_id_traveler',
    )
    ...
    shipping_cancelled_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_cancelled_email_template_id_sender',
    )
    ...
    shipping_traveller_price_validated_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_price_validated_email_template_id_traveler',
    )
    ...
    shipping_traveller_price_validated_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_price_validated_email_template_id_sender',
    )
    ...
    shipping_traveller_parcel_received_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_parcel_received_email_template_id_traveler',
    )
    ...
    shipping_traveller_parcel_received_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_parcel_received_email_template_id_sender',
    )
    ...
    shipping_traveller_parcel_received_email_template_id_receipient = fields.Many2one(
        'mail.template',
        string='Sender Shipping traveller parcel received Email Template',
        config_parameter='hubkilo_mails.shipping_traveller_parcel_received_email_template_id_receipient',
    )
    ...
    shipping_traveller_parcel_delivered_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_traveler',
    )
    ...
    shipping_traveller_parcel_delivered_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_sender',
    )
    ...
    shipping_traveller_parcel_delivered_email_template_id_recipient = fields.Many2one(
        'mail.template',
        string='Sender Shipping traveller parcel delivered Email Template',
        config_parameter='hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_recipient',
    )
    ...
    shipping_payment_complete_email_template_id_traveler = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_payment_complete_email_template_id_traveler',
    )
    ...
    shipping_payment_complete_email_template_id_sender = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_payment_complete_email_template_id_sender',
    )
    ...
    shipping_delivery_code_email_template_id_recipient = fields.Many2one(
        ...
        config_parameter='hubkilo_mails.shipping_delivery_code_email_template_id_recipient',
    )
    ...
    shipping_delivery_code_email_template_id_sender = fields.Many2one(
        'mail.template',
        string='Sender Shipping traveller parcel Delivery Code Email Template',
        config_parameter='hubkilo_mails.shipping_delivery_code_email_template_id_sender',
    )
    ...
    def get_values(self):
        ...
        enable_shipping_email_traveler = params.get_param('hubkilo_mails.enable_shipping_email_traveler')
        shipping_email_template_id_traveler = params.get_param('hubkilo_mails.shipping_email_template_id_traveler')
        enable_shipping_email_sender = params.get_param('hubkilo_mails.enable_shipping_email_sender')
        shipping_email_template_id_sender = params.get_param('hubkilo_mails.shipping_email_template_id_sender')

        enable_shipping_rejected_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_rejected_email_traveler')
        shipping_rejected_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_rejected_email_template_id_traveler')
        enable_shipping_rejected_email_sender = params.get_param('hubkilo_mails.enable_shipping_rejected_email_sender')
        shipping_rejected_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_rejected_email_template_id_sender')

        enable_shipping_cancelled_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_cancelled_email_traveler')
        shipping_cancelled_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_cancelled_email_template_id_traveler')
        enable_shipping_cancelled_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_cancelled_email_sender')
        shipping_cancelled_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_cancelled_email_template_id_sender')

        enable_shipping_traveller_price_validated_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_price_validated_email_traveler')
        shipping_traveller_price_validated_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_traveller_price_validated_email_template_id_traveler')
        enable_shipping_traveller_price_validated_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_price_validated_email_sender')
        shipping_traveller_price_validated_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_traveller_price_validated_email_template_id_sender')

        enable_shipping_traveller_parcel_received_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_received_email_traveler')
        shipping_traveller_parcel_received_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_received_email_template_id_traveler')
        enable_shipping_traveller_parcel_received_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_received_email_sender')
        shipping_traveller_parcel_received_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_received_email_template_id_sender')
        enable_shipping_traveller_parcel_received_email_receipient = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_received_email_receipient')
        shipping_traveller_parcel_received_email_template_id_receipient = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_received_email_template_id_receipient')

        enable_shipping_traveller_parcel_delivered_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_traveler')
        shipping_traveller_parcel_delivered_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_traveler')
        enable_shipping_traveller_parcel_delivered_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_sender')
        shipping_traveller_parcel_delivered_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_sender')

        enable_shipping_traveller_parcel_delivered_email_recipient = params.get_param(
            'hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_recipient')
        shipping_traveller_parcel_delivered_email_template_id_recipient = params.get_param(
            'hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_recipient')

        enable_shipping_payment_complete_email_traveler = params.get_param(
            'hubkilo_mails.enable_shipping_payment_complete_email_traveler')
        shipping_payment_complete_email_template_id_traveler = params.get_param(
            'hubkilo_mails.shipping_payment_complete_email_template_id_traveler')
        enable_shipping_payment_complete_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_payment_complete_email_sender')
        shipping_payment_complete_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_payment_complete_email_template_id_sender')

        enable_shipping_delivery_code_email_sender = params.get_param(
            'hubkilo_mails.enable_shipping_delivery_code_email_sender')
        shipping_delivery_code_email_template_id_sender = params.get_param(
            'hubkilo_mails.shipping_delivery_code_email_template_id_sender')

        enable_shipping_delivery_code_email_recipient = params.get_param(
            'hubkilo_mails.enable_shipping_delivery_code_email_recipient')
        shipping_delivery_code_email_template_id_recipient = params.get_param(
            'hubkilo_mails.shipping_delivery_code_email_template_id_recipient')
    ...
    def set_values(self):
        ...
        params.set_param('hubkilo_mails.enable_shipping_email_traveler', self.enable_shipping_email_traveler)
        params.set_param('hubkilo_mails.shipping_email_template_id_traveler',
                         self.shipping_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_email_sender', self.enable_shipping_email_sender)
        params.set_param('hubkilo_mails.shipping_email_template_id_sender',
                         self.shipping_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_rejected_email_traveler',
                         self.enable_shipping_rejected_email_traveler)
        params.set_param('hubkilo_mails.shipping_rejected_email_template_id_traveler',
                         self.shipping_rejected_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_rejected_email_sender',
                         self.enable_shipping_rejected_email_sender)
        params.set_param('hubkilo_mails.shipping_rejected_email_template_id_sender',
                         self.shipping_rejected_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_cancelled_email_traveler',
                         self.enable_shipping_cancelled_email_traveler)
        params.set_param('hubkilo_mails.shipping_cancelled_email_template_id_traveler',
                         self.shipping_cancelled_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_cancelled_email_sender',
                         self.enable_shipping_cancelled_email_sender)
        params.set_param('hubkilo_mails.shipping_cancelled_email_template_id_sender',
                         self.shipping_cancelled_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_traveller_price_validated_email_traveler',
                         self.enable_shipping_traveller_price_validated_email_traveler)
        params.set_param('hubkilo_mails.shipping_traveller_price_validated_email_template_id_traveler',
                         self.shipping_traveller_price_validated_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_traveller_price_validated_email_sender',
                         self.enable_shipping_traveller_price_validated_email_sender)
        params.set_param('hubkilo_mails.shipping_traveller_price_validated_email_template_id_sender',
                         self.shipping_traveller_price_validated_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_received_email_traveler',
                         self.enable_shipping_traveller_parcel_received_email_traveler)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_received_email_template_id_traveler',
                         self.shipping_traveller_parcel_received_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_received_email_sender',
                         self.enable_shipping_traveller_parcel_received_email_sender)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_received_email_template_id_sender',
                         self.shipping_traveller_parcel_received_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_received_email_receipient',
                         self.enable_shipping_traveller_parcel_received_email_receipient)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_received_email_template_id_receipient',
                         self.shipping_traveller_parcel_received_email_template_id_receipient.id or False)

        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_traveler',
                         self.enable_shipping_traveller_parcel_delivered_email_traveler)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_traveler',
                         self.shipping_traveller_parcel_delivered_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_sender',
                         self.enable_shipping_traveller_parcel_delivered_email_sender)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_sender',
                         self.shipping_traveller_parcel_delivered_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_traveller_parcel_delivered_email_recipient',
                         self.enable_shipping_traveller_parcel_delivered_email_recipient)
        params.set_param('hubkilo_mails.shipping_traveller_parcel_delivered_email_template_id_recipient',
                         self.shipping_traveller_parcel_delivered_email_template_id_recipient.id or False)

        params.set_param('hubkilo_mails.enable_shipping_payment_complete_email_traveler',
                         self.enable_shipping_payment_complete_email_traveler)
        params.set_param('hubkilo_mails.shipping_payment_complete_email_template_id_traveler',
                         self.shipping_payment_complete_email_template_id_traveler.id or False)
        params.set_param('hubkilo_mails.enable_shipping_payment_complete_email_sender',
                         self.enable_shipping_payment_complete_email_sender)
        params.set_param('hubkilo_mails.shipping_payment_complete_email_template_id_sender',
                         self.shipping_payment_complete_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_delivery_code_email_sender',
                         self.enable_shipping_delivery_code_email_sender)
        params.set_param('hubkilo_mails.shipping_delivery_code_email_template_id_sender',
                         self.shipping_delivery_code_email_template_id_sender.id or False)

        params.set_param('hubkilo_mails.enable_shipping_delivery_code_email_recipient',
                         self.enable_shipping_delivery_code_email_recipient)
        params.set_param('hubkilo_mails.shipping_delivery_code_email_template_id_recipient',
...
class RoadShippingMails(models.Model):
    ...
    # @api.model
    # def write(self, vals):
    #     shipping_cancelled = super(RoadShippingMails, self).write(vals)
    #
    ...
    #             if template_id:
    #                 template = self.env['mail.template'].browse(template_id)
    #                 template.send_mail(shipping_cancelled.id, force_send=True)
