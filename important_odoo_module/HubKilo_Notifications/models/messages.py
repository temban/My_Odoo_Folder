...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        shipping_price_proposed_email_template_id_traveler = params.get_param(
            'HubKilo_Notifications.shipping_price_proposed_email_template_id_traveler')
        ...
        shipping_price_proposed_email_template_id_sender = params.get_param(
            'HubKilo_Notifications.shipping_price_proposed_email_template_id_sender')
        ...
        shipping_price_validated_email_template_id_traveler = params.get_param(
            'HubKilo_Notifications.shipping_price_validated_email_template_id_traveler')
        ...
        shipping_price_validated_email_template_id_sender = params.get_param(
            'HubKilo_Notifications.shipping_price_validated_email_template_id_sender')
