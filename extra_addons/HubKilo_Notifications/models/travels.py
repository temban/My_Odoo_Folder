...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        published_travels_email_template_id = params.get_param('HubKilo_Notifications.published_travels_email_template_id') or self.env['mail.template'].sudo().search([('name', '=', 'HubKilo Road Travel Published Notification')], limit=1).id
