...
class MyModuleSettings(models.TransientModel):
    ...
    file1_name = fields.Char('SSL File Name:')
    file1_path = fields.Char('File 1 Path')
    file1_data = fields.Binary('Upload SSL Files:')
    ...
    @api.depends('file1_name', 'file1_path', 'uploaded_files')
    ...
    def set_values(self):
        ...
        if self.file1_data:
            filename = secure_filename(self.file1_name)
            ...
            with open(file_path, 'wb') as f:
                f.write(base64.b64decode(self.file1_data))
