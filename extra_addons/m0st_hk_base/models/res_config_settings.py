...
'hk_base_config_air_admin_fee_percentage' : 7.0,
...
class ResConfigSettings(models.TransientModel):
    ...
    hk_base_config_air_admin_fee_percentage = fields.Float(string='Air Administrative Percentage Fee', digits=(2, 2),
                                                           help="The percentage to set for air shipping administrative fee")
...
##        irConfig.set_param('m0st_hk_base.hk_base_config_currency_id', self.hk_base_config_currency_id.id)
        ...
        irConfig.set_param('m0st_hk_base.hk_base_config_air_admin_fee_percentage', self.hk_base_config_air_admin_fee_percentage)
    ...
    def get_values(self):
        ...
        hk_base_config_air_admin_fee_percentage    = irConfig.get_param('m0st_hk_base.hk_base_config_air_admin_fee_percentage') or DICT_DEFAULT_VALUES['hk_base_config_air_admin_fee_percentage']
        ...
        res.update({ 'hk_base_config_min_age' : hk_base_config_min_age,
                    ...
                    'hk_base_config_percentage': hk_base_config_percentage,
                     'hk_base_config_air_admin_fee_percentage': hk_base_config_air_admin_fee_percentage,
