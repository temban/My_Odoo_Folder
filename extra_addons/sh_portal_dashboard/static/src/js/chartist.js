                ...
                function (projectedValue, index) {
                    ...
                    if (axisOptions.showLabel) {
                        Chartist.createLabel(
                            ...
                            labelOffset,
                            labelGroup,
                            [chartOptions.classNames.label, chartOptions.classNames[this.units.dir], axisOptions.position === "start" ? chartOptions.classNames[axisOptions.position] : chartOptions.classNames["end"]],
                            useForeignObject,
                            eventEmitter
                        );
                    }
